...
- **Dropdown:** แถวเดียวแบบ Toggle (ชื่อซ้าย กล่องขวา 168px) — เมนูเต็มความกว้างเหมือนเดิม
- **Stats:** head บรรทัดเดียว · ค่า off/idle จาง · ตัวเลขยังขาวจัด · ไม่มี text-stroke
